...
print(isinstance(objeto, Op_basicas)) # Devuelve un booleano al verificar que una variable este instanciada a una clase especifica
print(issubclass(Op_basicas, Calculadora)) # Devuelve un booleano al verificar si una clase es subclase de otra.